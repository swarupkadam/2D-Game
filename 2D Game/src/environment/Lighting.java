...
public class Lighting {
	...
	public void setLightSource() {
		...
		if(gp.player.currentLight == null) {
			...
			// CReate a gradation effect between the circle
			...
			// create a gradation pain settings for the light circle
