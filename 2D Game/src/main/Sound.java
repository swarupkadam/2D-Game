...
public class Sound {
	...
	public Sound() {
		soundURL[0] = getClass().getResource("/sound/forest_bgm.wav");
		...
		soundURL[9] = getClass().getResource("/sound/click.wav");
		soundURL[10] = getClass().getResource("/sound/fireballsound.wav");
		soundURL[11] = getClass().getResource("/sound/wood_chop.wav");
		...
		soundURL[18] = getClass().getResource("/sound/complete.wav");
	}
