...
public class Entity {
	...
	public boolean offBalance = true;
	public Entity loot;
	...
	public void dropItem(Entity droppedItem) {
		...
		for(int i = 0; i < gp.obj[1].length; i++) {//FIXED
			if(gp.obj[gp.currentMap][i] == null) {
				gp.obj[gp.currentMap][i] = droppedItem;//FIXED
				gp.obj[gp.currentMap][i].worldX = worldX; // dead monster's worldX //FIXED
				gp.obj[gp.currentMap][i].worldY = worldY; // dead monster's worldY //FIXD
				break;
			}
		}
	}
	...
	public void attacking() {
		...
		if(spriteCounter > motion1_duration && spriteCounter <= motion2_duration) {
			...
			if(type == type_monster) {
				...
				//check monster collision with the updated worldX/y and solid area
	...
	public void searchPath(int goalCol, int goalRow) {
		...
		if(gp.pFinder.search() == true) {
			...
			// nExt worldX and world Y
			int nextX = gp.pFinder.pathList.get(0).col * gp.tileSize;
			int nextY = gp.pFinder.pathList.get(0).row * gp.tileSize;
			
			// Entitys solid area position
			...
			//if rreaches the goal stop the search
